...
ftpPassword1='Nr2013!!'
awsdevUser=evsuser
awsdevPassword=Ev$@dm1n1$tr@t0r!
...
echo 
echo $dataDir/$1
cp $dataDir/$1 $dataDir/$assertedFilename
...
previousInferredPath=$prefix$dataDir/$2 
...
#cd OWLSummary
#/usr/java8/bin/java -Xmx12000m -jar ./owlsummary-2.0.0-jar-with-dependencies.jar -I $inferredPath -S file:///local/content/ProcessingData/CTRP-Summary.txt
...
/usr/java8/bin/java -Xmx8000M -jar ./owlscrubber-2.1.0-jar-with-dependencies.jar -C ./owlscrubber.properties -E -N $LVGOutput -O $ProdOutput
cd /local/content/vocab_processing_OWL2
...
#cp -r $inferredByCodeStardog /LexBIG/rawdata/TripleStore/
#cp -rf ThesaurusInferred_forTS.owl /LexBIG/rawdata/TripleStore/
#cp -rf ThesaurusInferred_forTS.rdf /LexBIG/rawdata/TripleStore/
...
#echo "Connecting to AWS and uploading files"
...
echo "Coping to aws s3 evs-prod and evs-nonprod  "
aws s3 cp  /local/content/vocab_Processing_OWL2/ProcessingData/ThesaurusInferred_forTS.zip s3://nci-cbiit-evs-nonprod
aws s3 cp  /local/content/vocab_Processing_OWL2/ProcessingData/ThesaurusInferred_forTS.zip s3://nci-cbiit-evs-prod

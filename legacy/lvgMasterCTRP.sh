...
/usr/java8/bin/java -Xmx20000m -jar ./GenerateOWLAPIInferred-2.0-jar-with-dependencies.jar $prefix$dataDir/$assertedFilename
cd ..
...
#dss='DSS_CTRPThesaurusInf-210208-21.02b.owl-lvg.owl'
#cp $dataDir/$dss  $LVGOutput
